...
def generate_2D_occupancy_map(world_dat, threshold=3, dir_path='./results/occ_map.png'):
    '''
...
def get_closest_to(empty_spots, target_pos = np.array([.0, .0]), collision_diameter=0.2):
...
def get_empty_spot(pcd):
    ...
    closest_empty_spot = get_closest_to(empty_spots)
